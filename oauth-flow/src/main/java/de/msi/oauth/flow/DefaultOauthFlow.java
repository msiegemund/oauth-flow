...
final class DefaultOauthFlow implements OAuthFlow {
    private final RequestTokenFlowParam rtfp;

    DefaultOauthFlow(RequestTokenFlowParam rtfp) {
        this.rtfp = Objects.requireNonNull(rtfp, "the RequestTokenFlowParam is mandatory");
    }

    @Override
    public RequestTokenFlow requestTokenFlow() {
        return new DefaultRequestTokenFlow(this.rtfp);
    }
